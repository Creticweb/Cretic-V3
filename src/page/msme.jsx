                  ...
                  <div className="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="17.06" height="17.06" viewBox="0 0 17.06 17.06">
                      <g id="Group_6271" data-name="Group 6271" transform="translate(-3.343 -3.597)">
                        <path id="Combined-Shape" d="M15.95,3.808,13.025,6.733a2,2,0,0,0,0,2.828l1.414,1.414a2,2,0,0,0,2.828,0L20.192,8.05a5.92,5.92,0,0,1-8.308,6.894L6.757,20.071a2,2,0,1,1-2.828-2.828l5.127-5.127A5.92,5.92,0,0,1,15.95,3.808Z" fill="#0b2238" fillRule="evenodd" />
                        <path id="Rectangle-2" d="M16.657,5.929l1.414,1.414a1,1,0,0,1,0,1.414l-1.38,1.38a1,1,0,0,1-1.414,0L13.863,8.723a1,1,0,0,1,0-1.414l1.38-1.38A1,1,0,0,1,16.657,5.929Z" fill="#0b2238" fillRule="evenodd" opacity="0.3" />
                      </g>
                    </svg>
                  </div>
                  ...
                  <div className="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16.94" height={17} viewBox="0 0 16.94 17">
                      <g id="Group_6274" data-name="Group 6274" transform="translate(-3.06 -3)">
                        <path id="Combined-Shape" d="M4,12.2,13,14V4.062A8,8,0,1,1,4,12.2Z" fillRule="evenodd" opacity="0.3" />
                        <path id="Combined-Shape-Copy" d="M3.06,10.012A8,8,0,0,1,11,3v8.6Z" fillRule="evenodd" />
                      </g>
                    </svg>
                  </div>
                  ...
                  <div className="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width={16} height={18} viewBox="0 0 16 18">
                      <g id="Group_6273" data-name="Group 6273" transform="translate(-4 -3)">
                        <path id="Rectangle" d="M6,3H18l2,3.5H4Z" fill="#0b2238" fillRule="evenodd" opacity="0.3" />
                        <path id="Combined-Shape" d="M6,5H18a2,2,0,0,1,2,2V19a2,2,0,0,1-2,2H6a2,2,0,0,1-2-2V7A2,2,0,0,1,6,5ZM9,9a1,1,0,0,0,0,2h6a1,1,0,0,0,0-2Z" fill="#0b2238" fillRule="evenodd" />
                      </g>
                    </svg>
                  </div>
